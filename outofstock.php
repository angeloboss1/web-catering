...
<div class="container">
	...
	$sql= "SELECT sku, Product_name, Product_desc, Quantity FROM inventory WHERE username = '$username' AND Quantity = 0";
	$result = $conn->query($sql);
	if ($result->num_rows > 0) {
	echo "You have " . $result->num_rows . " items out of stock<br><br>"; ?>
</div>
...
<?php
    while($row = $result->fetch_assoc()) {
        ...
        echo "<tr> <td>" . $row["sku"]. "</td>" . "<td>". $row["Product_name"]."</td>" . "<td>" . $row["Product_desc"] . "</td>" . "<td>" . $row["Quantity"] . "</td></tr>";
    }
} else {
    echo "0 results";
}
	...
	<br><br><center><img src="image/OutOfStock1.jpg" style="width: 60%;" ></center>
</div>				
</div>
